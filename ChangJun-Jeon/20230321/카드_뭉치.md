...
## 입출력 예
![Screenshot 2023-03-22 at 12 49 18 PM](https://user-images.githubusercontent.com/86146128/226797390-3233390b-7d66-49da-aebf-32e78fa91ceb.png)
...
class Solution {
    public String solution(String[] cards1, String[] cards2, String[] goal) {
        ...
        while(idx < goal.length){
            if(lt < cards1.length && goal[idx].equals(cards1[lt])){
                idx++;
                lt++;
                
            }else if(rt < cards2.length && goal[idx].equals(cards2[rt])){
                idx++;
                rt++;
            }else{
                answer = "No";
